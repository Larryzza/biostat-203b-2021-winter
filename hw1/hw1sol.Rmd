...
```
```{bash}
echo "admission_type: (count & values)"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | 
awk  -F ',' '{ print $6}' | tail -n +2 | sort | uniq -c 
echo "admission_location: (count & values (*NULL included))"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | 
awk  -F ',' '{ print $7}' | tail -n +2 | sort | uniq -c 
echo "insurance: (count & values (*NULL included))"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | 
awk  -F ',' '{ print $9}' | tail -n +2 | sort | uniq -c 
echo "language: (count & values (*NULL included))"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | 
awk  -F ',' '{ print $10}' | tail -n +2 | sort | uniq -c 
echo "marital_status: (count & values (*NULL included))"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | 
awk  -F ',' '{ print $11}' | tail -n +2 | sort | uniq -c 
echo "ethnicity: (count & values (*NULL included))"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | 
awk  -F ',' '{ print $12}' | tail -n +2 | sort | uniq -c 
```
```{bash}
echo "admission_location: (time & values)"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | 
awk  -F ',' '{ print $7}'| tail -n +2 | sort | uniq -c 
```
