...
grep -o 'Elizabeth' pride_and_prejudice.txt | wc -l
echo "number of times Jane is mentioned:"
grep -o 'Jane' pride_and_prejudice.txt | wc -l
echo "number of times Lydia is mentioned:"
grep -o 'Lydia' pride_and_prejudice.txt | wc -l
echo "number of times Darcy is mentioned:"
grep -o 'Darcy' pride_and_prejudice.txt | wc -l
```
